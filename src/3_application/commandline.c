...
void prvUARTCommandConsoleTask( void *pvParameters )
{
	...
	/* Enable Interrupt for USART RX. USART2 MUST NOT be used by another function or task!!!*/
	USART_ITConfig(USART2, USART_IT_RXNE, ENABLE);

	USART_sendSuspend(USART2, "FreeRTOS command server.\r\nType Help to view a list of registered commands.\r\n\r\n>", NULL);
	...
	for( ;; )
	{
		...
		USART_sendSuspend(USART2, (char*)pcOutputString, NULL);
		...
		if( cRxedChar == '\n' || cRxedChar == '\r')
		{
			...
			USART_sendSuspend(USART2, (char*)pcEndOfCommandOutputString, NULL);
		}
		else
		{
			if( cRxedChar == '\b' )
